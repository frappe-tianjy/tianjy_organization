<template>
	<div class="inheritable-organization " v-loading="loading">
		...
		<ElTable :data="inheritList" border style="width: 100%" height="100%">
			<ElTableColumn prop="inherit_from_organization_doc.label" label="继承自" ></ElTableColumn>
...
import { ElButton, ElTree, ElTable, ElTableColumn, vLoading } from 'element-plus';
